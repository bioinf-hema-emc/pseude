...
2.  `comparison`: See Input point 4 for the `scdeseq` function for more
    details.
3.  `out_path`: Defaults to the working directory. If you wish to place
    the pdf file elsewhere, add the path here as string.
...
``` r
schow(dds = aggregated_dds, comparison = "state,young,old",
